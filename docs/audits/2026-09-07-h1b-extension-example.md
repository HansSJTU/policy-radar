# H-1B extension example — targeted check, 2026-09-07 ET

Scope: Add a hypothetical same-employer H-1B extension example to the prevailing-wage policy. No policy stage, effective date, or global audit date changed.

Sources read via search excerpts:
- https://flag.dol.gov/programs/LCA — required pay is the higher of the actual and prevailing wage; prevailing wage relates to the occupation and intended employment area at filing.
