...
export const optFee: PolicyContent = {
  ...
  zh: {
    ...
    reviewNote:
      '核查范围：9·22 读取 OIRA 结案记录、联邦公报检索及新旧论坛主题的最新可访问回复。未核实公开 NPRM，官方金额和缴费方仍待正文确认；论坛回复不是官方条款。',
    background:
  ...
  en: {
    ...
    reviewNote:
      'Review scope: the OIRA conclusion record, Federal Register search and latest accessible replies in both forum topics were reviewed September 22. A public NPRM was not verified; the official amount and payer still require published text. Forum replies are not official terms.',
    background:
