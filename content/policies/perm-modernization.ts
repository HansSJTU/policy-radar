...
export const permModernization: PolicyContent = {
  ...
  zh: {
    ...
    reviewNote:
      '9·26 重读 OIRA 9·14 待审记录并按 RIN 检索联邦公报；尚未核实公开 NPRM，检索未命中不证明没有后续文件。',
    background:
