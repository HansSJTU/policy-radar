...
export const permModernization: PolicyContent = {
  ...
  zh: {
    ...
    reviewNote:
      '9·22 读取 OIRA 9·14 待审记录并检索联邦公报。未找到可验证的后续 NPRM；检索未命中不证明不存在后续文件。',
    background:
  ...
  en: {
    ...
    reviewNote:
      'The September 14 pending OIRA record and Federal Register search were reviewed September 22. No subsequent NPRM was verified; a search miss is not proof that no later document exists.',
    background:
