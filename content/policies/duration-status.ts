    ...
    impacts: [
      {
        ...
        text: '下面说的是规则原本会带来的影响，现在都不实施。研究和论文未必能精确按期完成。如果单独办延期，准备材料和等审理的时间会占进学业规划。',
        examples: [
      ...
      },
      {
        ...
        text: '下面说的是规则原本会带来的影响，现在都不实施。在新制度下，OPT 申请通常还要一起办 I-539 延期。身份和工作授权能不能接上，会影响实际入职时间；已经持有 D/S 的人要单独核对过渡条款。',
        examples: [
      ...
      },
      {
        ...
        text: '下面说的是规则原本会带来的影响，现在都不实施。新规则禁止研究生在读期间改变学位层级，也限制中途转学。同级或降级再入学的限制，只计算生效后完成的学位。这些要求会先影响学生身份，再影响依赖身份的 OPT 或 CPT 安排。',
        examples: [
    ...
    impacts: [
      {
        ...
        text: 'This describes the stayed rule’s intended effect; it is not currently implemented. Research, dissertations, and training plans do not always finish on an exact schedule. If a separate extension is required, document preparation and processing time become part of academic planning.',
        examples: [
