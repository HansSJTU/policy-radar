...
export const homeCopy = {
  zh: {
    ...
    impact: '路径冲击', processProgress: { 'federal-rulemaking': '规则制定进度', 'administrative-guidance': '行政指引进度', 'executive-order': '行政命令进度' } satisfies Record<ProcessKind, string>, swipe: '左右滑动查看完整流程 →', currentProcess: '当前流程：', litigation: '诉讼进展',
  ...
  en: {
    ...
    impact: 'Path impact', processProgress: { 'federal-rulemaking': 'Rulemaking progress', 'administrative-guidance': 'Guidance progress', 'executive-order': 'Executive order progress' } satisfies Record<ProcessKind, string>, swipe: 'Swipe for full process →', currentProcess: 'Current process: ', litigation: 'Court proceedings',
