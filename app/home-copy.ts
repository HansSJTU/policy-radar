...
export const homeCopy = {
  zh: {
    ...
    footer: `更新于 ${SITE_UPDATED_ON}（美东）。单项核查范围及缺口见详情；预计日期可能因规则修改或诉讼变化而移动。个人决定请复核原始文件与专业意见。`, seedDisclosure: '社区影响均分目前包含每项政策 10–20 个用于上线初始化的模拟样本；这些样本已在数据库中单独标记，待真实评分积累后将删除。', top: '回到顶部 ↑',
  },
  en: {
    ...
    footer: `Updated ${SITE_UPDATED_ON} (Eastern Time). See individual entries for review scope and gaps. Estimated dates may change. Verify primary sources and obtain professional advice before making individual decisions.`, seedDisclosure: 'Community-impact averages currently include 10–20 synthetic launch samples per policy. They are marked separately in the database and will be removed after genuine ratings accumulate.', top: 'Back to top ↑',
  },
};
