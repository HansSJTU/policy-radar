  ...
  },
{
  ...
  },
  {
    ...
    discovery: {
      ...
      summary: 'DOL plans to update PERM recruitment, layoff protections and employer compliance.',
    ...
    audience: 'employees and employers preparing PERM-based green-card sponsorship, including applicants in H-1B status.',
    caveat: 'This concerns permanent labor certification. It is separate from H-1B cap selection and the #06 wage-level proposal, RIN 1205-AC30.',
    summary: 'DOL plans to update the PERM labor-market test, raise minimum standards for recruiting qualified U.S. workers, strengthen protections for laid-off U.S. workers, and improve nondiscriminatory recruitment, hiring and recordkeeping requirements.',
    background: 'PERM is the labor certification process employers use when pursuing permanent employment-based immigration for foreign workers. The Unified Agenda lists this action under 20 CFR 656, and DOL submitted it to OIRA on September 14, 2026. The agenda originally targeted July 2026 for an NPRM; this September 17 check did not locate published text. That target is not a publication or effective date.',
    note: 'Submission does not change current requirements; detailed terms and transition provisions await public text',
    deck: 'After an employer promises green-card sponsorship, how could recruitment and compliance requirements change?',
    headline: 'Preparing employer-sponsored green-card cases could require more compliance work.',
    analysis: 'Our assessment: if recruitment and recordkeeping requirements become stricter (for example, advertising through more channels or documenting resume screening, interviews and reasons for not hiring in greater detail), employers could need more staff time to prepare PERM cases. Employers that have experienced layoffs could also face more complex checks of relevant positions and recruitment records. These examples are hypothetical, not published new requirements. The agenda provides only a direction; it does not establish new documents, a specific delay, or which pending cases would be affected.',
    teaser: 'Higher recruitment and recordkeeping requirements could change the work and timing needed to prepare PERM cases.',
    impacts: [
      ['For employers: recruitment and documentation work could grow', 'Higher minimum recruitment and recordkeeping standards could require process changes and additional evidence. The new steps and their costs cannot yet be quantified.'],
      ['For employers with layoffs: U.S.-worker protections could become stricter', 'The official agenda expressly identifies stronger protections for laid-off U.S. workers, but does not publish the relevant time periods, positions or notification duties. It does not establish a blanket PERM ban following layoffs.'],
      ['For H-1B employees: later green-card plans may need adjustment', 'If employer preparation takes longer, the employee’s green-card filing plans could shift. This is conditional impact analysis; submission for review does not itself cancel existing H-1B status.'],
    ],
    outlook: 'Our assessment: watch the OIRA review outcome and NPRM text, particularly recruitment channels, layoff-related duties, recordkeeping and treatment of new versus existing cases. Until those terms are public, a fixed delay or probability of adoption cannot be established.',
    scenarios: [
      ['Review continues or the plan changes', 'Current requirements continue to apply', 'OIRA review remains open or DOL revises the plan.', 'Employers can prepare cases under current rules. An agenda abstract alone cannot establish future additional requirements.', 'Whether OIRA closes review and DOL publishes a formal proposal.'],
      ['An NPRM opens for public comment', 'Employers assess specific process changes', 'DOL publishes proposed terms and a public-comment window.', 'Employees and employers can assess preparation work against the text. Publication of a proposal alone does not make new requirements effective.', 'Recruitment standards, layoff protections, recordkeeping and proposed coverage.'],
      ['A final rule takes effect', 'PERM processes adjust within the final scope', 'DOL completes rulemaking and the final rule reaches its effective date.', 'Changes for new or existing cases depend on the final terms, transition provisions and any relevant court orders.', 'The effective date, transition terms and treatment of recruitment already conducted or cases already filed.'],
    ],
    scope: [
      ['Relevant process', 'PERM permanent labor certification under 20 CFR 656.'],
      ['H-1B connection', 'Primarily later employer-sponsored green-card processing, rather than a direct change to cap selection or H-1B eligibility.'],
