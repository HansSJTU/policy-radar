...
export const englishPolicyEditorial: PolicyEditorial[] = [
  {
    ...
    summary:
      'September 11 development (checked September 19): OIRA completed OPT fee proposal review with changes. The $100,000 figure remains media-reported. The official amount, payer, covered applications and exemptions are unpublished; student, employer or school payment cannot be assumed. It is not in effect.',
    background:
