...
const processTracks: Record<string, ProcessTrack> = {
  ...
  'grace-period': {
    ...
    meaning: federalMeaning,
    detail:
      'OIRA 已完成发布前审查，目前等待 DHS 在 Federal Register 发布 NPRM。',
    currentSummary: 'OMB 已放行，等待正文',
    lastCompletedStage: 1,
    activeStage: null,
    nextStage: 2,
    waitingFor: 'DHS 在 Federal Register 发布 NPRM；提案尚未公开。',
    stages: federalRulemakingStages,
    litigation: [],
  },
  'ead-discretion': {
...
> = {
  ...
  'grace-period': {
    ...
    meaning: federalMeaningEnglish,
    detail:
      'OIRA has completed prepublication review. DHS can now publish the NPRM in the Federal Register.',
    waitingFor:
      'DHS publication of the NPRM in the Federal Register; the proposal is not yet public.',
