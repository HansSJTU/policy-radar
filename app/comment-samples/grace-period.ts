...
export default {
  ...
  scopeNote: {
    zh: '基于已公开526条中的固定随机50条；1条仅有附件且附件不可读，保留为不明确。观点摘要为评论者主张，并非事实或法律结论。',
    en: 'Fixed random sample of 50 from 526 published comments; one attachment-only comment was unreadable and retained as unclear. Summaries describe commenters’ views, not factual or legal findings.',
  },
  commentPhase: 'open',
