...
export const verifiedSchools: VerifiedSchool[] = [
{
  ...
  "state": "9·15 宣布暂停新的非全员必需 CPT",
  "detail": "ISSA 暂停新的 optional CPT，即非学位项目全体学生必需的实践授权，同时审查校内政策与流程；该公告没有宣布撤销已签发授权。",
...
},
{
  ...
  "state": "暂停非学位必需的新 CPT；学位必需请求继续处理",
  "detail": "校方 CPT 页面与 FAQ 要求实践为项目每位学生完成学位所必需，仅有选修课或学分不足；已获批的 2026 秋季 CPT 可按计划继续。页面未标明本次政策更新日期。",
...
},
{
  ...
  "state": "新的 CPT 仅限应用行为分析与临床健康心理学两个硕士项目",
  "detail": "OIA 当前仅列 MS in Applied Behavior Analysis 与 MS in Clinical Health Psychology 可申请新的 CPT；其他项目学生暂勿注册 CPT 课程或提交申请。已批准的 2026 秋季 CPT 不取消或修改。本条仅限 Dearborn 校区，CPT 栏未单独标注更新日期。",
...
},
  {
    ...
    detail: 'Degree Requirement CPT 仅适用于全专业学生均须完成的实践；Thesis/Dissertation Requirement CPT 仅限已 Advanced to Candidacy 的论文型硕士或博士，且训练必须是完成论文所必需、无法由其他研究或数据收集方式合理替代，并需导师书面证明。校方另明确：CPT 指引独立于 D/S 规则，不因 D/S 法院裁定而自动改变。',
  ...
  },
  {
    ...
    detail: '保留 8·25 校方通知的历史口径。核查缺口：9·16 重试仍无法读取原公告，尚未确认当前流程，最后成功核对日期保留 9·14。',
  ...
  },
  {
    ...
    detail: 'OISS 9·03 通知称，除非 SEVP 指引改变，学校不能批准非项目全体学生必需的实践类 CPT；学校正与各项目核实资格。',
  ...
  },
  {
    ...
    detail: '9·08 后续通知明确驳回所有秋季待审的非必需 CPT；新申请须由学术顾问证明实践属于学生主修项目既定课程中全体学生的必需要求。8·26 通知允许已获授权者按 I-20 条件继续；9·08 未宣布撤销既有授权。',
  ...
  },
  {
    ...
    detail: 'International Center 公开通知称暂停 Course Credit CPT 申请，直至另行通知；Degree Requirement CPT 须在 UCI 课程目录中列为毕业要求。核查缺口：9·16 原页访问失败，搜索仅返回较早通用页面，无法确认暂停是否延续，最后成功核对日期保留 9·14。',
  ...
  },
  {
    ...
    detail: '9·08 校方通知暂停 8·12 起提交的非全员毕业必需申请；论文、研究或 capstone 所需实践也须列入 UCLA General Catalog 的全员项目要求。8·12 前已获批并签发 CPT I-20 的授权不受影响，所有 CPT 申请须附院系与雇主的合作协议。',
  ...
  },
  {
    ...
    detail: 'ISSS 最新通知称，仅恢复处理实践为既定课程必要且必需组成部分的请求；须经院系确认并由雇主完成 Penn 合作协议，获批并取得新 I-20 后才能工作。同页下方仍保留待审请求暂停的旧说明，个案恢复进度须向 ISSS 确认，不能视为全面恢复。',
  ...
  },
  {
    ...
    detail: 'OGS 9·09 更新称，实践必须为既定课程全体学生（不分国籍）必需；学校已联系 8·24 时待审申请人及持有秋季授权的学生讨论影响和选项，未承诺所有既有授权均不受影响。该日期是校方更新日，不是新的 SEVP 指引发布日期。',
  ...
  },
  {
    ...
    detail: '校方 Immigration Announcements 页（页头日期 9·10，CPT 栏标题为 2026 年 8 月）称，因 8·24 联邦指引，暂缓新申请和待审请求的决定，正加速审查课程及流程；未说明既有授权如何处理，也未给出恢复日期。',
  ...
  },
{
  ...
  "detail": "OISS 9·09 公告要求实践既为毕业必需，也为该学位项目所有学生必需；仅作为可选学分的实践不符合要求。校方将暂停不满足全员必需条件的校外实践 CPT，公告未说明既有授权的处理。",
...
},
{
  ...
  "detail": "OIS 页首新通知称，只批准毕业必需且符合 SEVP 备忘录的实习／实践；此类请求继续处理。页面下方仍有旧选修课程口径，不能据此认定选修 CPT 已恢复；未说明既有授权处理。",
...
},
{
  ...
  "detail": "8·07 校方公告称，自 2027 年春季起，学年内不再批准全职 CPT，课程明确要求的实习除外。该通知早于 8 月 SEVP 备忘录，不代表当前全面停批，也未说明取消暑期或兼职 CPT；公告提示并非适用所有校区。核查范围：已读校方页面的搜索索引正文，直接访问受限，后续执行状态仍待复核。",
