...
export const briefingItems: BriefingItem[] = [
{
  ...
  "rank": 3,
  "policy": "D/S 固定期限",
  "summary": "议员宣布提出 CRA 决议，拟撤销最终规则；提出不等于成法，法院全国暂缓是另一个程序。",
  "timing": "recent",
  "confirmed": true
},
...
export const englishBriefing: Record<string, Pick<BriefingItem, 'policy' | 'summary'>> = {
  ...
  'duration-cra-introduced': { policy: 'D/S final rule', summary: 'Lawmakers announced a CRA resolution to disapprove the final rule. Introduction is not enactment; the nationwide court stay is a separate proceeding.' },
