...
const briefingItems: BriefingItem[] = [
  ...
  {
    id: 'duration-government-response',
    date: '2026-08-31',
    policyId: 'duration-status',
    rank: 3,
    policy: 'D/S 固定期限',
    summary: '政府对初步禁令申请的答辩截止；文件将决定 9·03 听证的主要争点。',
    timing: 'upcoming',
    confirmed: true,
  },
  {
    ...
    rank: 3,
    policy: 'D/S 固定期限',
    summary: '法院举行初步禁令听证；规则是否暂停可能在生效日前明确。',
    timing: 'upcoming',
    confirmed: true,
  },
  {
...
const englishBriefing: Record<string, Pick<BriefingItem, 'policy' | 'summary'>> = {
  ...
  'duration-government-response': { policy: 'Fixed F/J admission period', summary: 'The government’s response to the preliminary-injunction motion is due; the filing will frame the main issues for the September 3 hearing.' },
  'duration-injunction-hearing': { policy: 'Fixed F/J admission period', summary: 'The court will hold a preliminary-injunction hearing. Whether the rule is stayed may become clear before its effective date.' },
