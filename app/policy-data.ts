  ...
  },
{
  ...
  "tone": "amber",
  "current": "麻省联邦法院在 2026-09-14 美东下午 4:55 签发第 51 号初步禁令。命令同时依据 APA § 705 推迟整项最终规则生效，并禁止 DHS/ICE 采取任何进一步实施行动。这一状态持续到法院另有命令，或案件实体审理结束，没有设到期日。第 50 号意见第 46—48 页写明，这项救济覆盖全国，不限于原告成员学校；第 42 页认定该最终规则在 APA 意义上属于 arbitrary and capricious。原定 9·15 生效的安排已经作废。法院还没有永久撤销规则，也没有作出有利于原告的简易判决。相关请求被无偏见驳回，可以再次提出。9·22 读取的公开案卷镜像仍止于第 52 项，未见上诉记录；镜像可能滞后。第 52 项另定 10·02 中午 12 点在波士顿第 1 法庭开现场状态会议，这个日期不是新的生效日。另据议员官网 9·14 公告，Durbin 等参议员已提出 CRA 联合否决决议，拟撤销这项最终规则，Jayapal 和 Raskin 牵头众议院配套案。提出决议本身不撤销规则，也不是法院裁定；后续表决和成法进度仍待核实。",
  "route": [
    "F-1",
    "CPT",
    "OPT"
  ...
  },
  {
    ...
    tone: 'blue',
    current:
      'DOL / ETA 的 RIN 1205-AC29 在 2026-09-14 送交白宫 OIRA，做拟议规则的发布前审查。议程把本项列在 20 CFR 656 之下。截至 9 月 22 日核查，没有找到公开的 NPRM 正文、评论截止日或生效日。议程里的 2026 年 7 月只是原计划的提案月份，不代表已经发布或生效。',
