...
export const policies: Array<{
  ...
  },
  {
    ...
    tone: 'red',
    current:
      '2025 年的拟议规则已在 2026-07-17 变成最终规则。F/J 最长按项目获批、但通常不超过四年；延期需向 USCIS 申请。现有 D/S 持有人有过渡条款，但生效后出境再入境通常会进入固定期限制度。法院于 9·03 听取双方陈述后将禁令申请留待裁定，即法官没有当庭作出决定、将继续审议并可能另行发布书面命令；这既不代表批准禁令，也不代表驳回禁令。 9·12 补充核对庭审记录：法官在 9·03 听证结尾表示，希望最迟 9·14 作出决定，也可能先签发短期临时限制令（TRO）以争取审议时间；这是时间目标和可能方案，不是已签发命令（第 70 页）。',
    route: ['F-1', 'CPT', 'OPT'],
    milestones: [
