  ...
  },
{
  ...
  "tone": "amber",
  "current": "麻省联邦法院在 2026-09-14 美东下午 4:55 签发第 51 号初步禁令。禁令依据 APA § 705 推迟整项最终规则生效，并禁止 DHS/ICE 继续实施。这一状态持续到法院另有命令，或案件实体审理结束。第 50 号意见第 46—48 页写明，这项救济覆盖全国，不限于原告成员学校。原定 9·15 生效的安排已经作废。法院还没有永久撤销规则，也没有作出有利于原告的简易判决。相关请求被无偏见驳回，可以再次提出。案卷第 52 项另定 10·02 中午 12 点在波士顿第 1 法庭开现场状态会议，这个日期不是新的生效日。",
  "route": [
    "F-1",
    "CPT",
    "OPT"
