...
export const englishPolicies: Record<string, EnglishPolicy> = {
  ...
  'perm-modernization': {
    ...
    current: 'DOL / ETA sent RIN 1205-AC29 to White House OIRA on September 14, 2026, for prepublication review of a proposed rule. The action sits under 20 CFR 656. This September 22 check did not locate a public NPRM, comment deadline or effective date. The agenda’s July 2026 entry was only a planned proposal month, not evidence of publication or effectiveness.',
...
export const englishVerifiedSchools: Record<string, { state: string; detail: string }> = {
  ...
  "Kennesaw State University": {
    "state": "From Fall 2026: limited to Education, Nursing and Social Work programs",
  ...
  "University of Toledo": {
    "state": "September 8 update: optional internships and electives do not establish CPT eligibility",
