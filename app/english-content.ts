...
export const englishPolicies: Record<string, EnglishPolicy> = {
  ...
  'h1b-fee': {
    ...
    current: 'DHS published RIN 1615-AD20 on August 25, 2026. The proposal would add $103,265 to the existing filing fees for each cap-subject H-1B petition. Cap-exempt petitions would not pay this surcharge. The September 10 correction replaces historical receipt figures in Table 13; it does not change the proposed amount, scope, or September 24 comment deadline. A separate, earlier charge is also tracked here: the $100,000 payment under Presidential Proclamation 10973 of September 19, 2025. The District of Massachusetts vacated its implementation on June 8, 2026, and the First Circuit denied the government’s stay request on July 24, 2026. USCIS is not currently collecting that payment, and the appeal continues. The proclamation’s text makes the restriction expire, absent extension, on September 21, 2026.',
    ...
    milestones: [
      ...
      { date: '2025-09-19', text: 'Presidential Proclamation 10973 was signed, requiring a $100,000 payment for certain H-1B entries from September 21, 2025.' },
      { date: '2026-06-08', text: 'The District of Massachusetts vacated implementation of the earlier proclamation in State of California v. Mullin; the government appealed.' },
      { date: '2026-07-24', text: 'The First Circuit denied the government’s motion to stay; the vacatur stays in effect while the appeal remains pending.' },
    ...
    next: [
      ...
      { date: '2026-09-21', text: 'Textual expiry date of the $100,000 restriction in Proclamation 10973; no public decision on an extension or on the appeal has been issued.' },
    ...
    impacts: [
      ...
      'The older $100,000 proclamation payment is not currently collected. A different appellate outcome could restore the payment requirement.',
    ],
    sourceLabels: ['Federal Register September 10 correction', 'Federal Register NPRM', 'Presidential Proclamation 10973 (published September 24, 2025)', 'USCIS alert: $100,000 vacatur and the First Circuit’s July 24 order', 'USCardForum discussion'],
  },
  'duration-status': {
  ...
  'cpt-guidance': {
    ...
    sourceLabels: ['Bryn Mawr · September 15 notice', 'SEVP August 12 Broadcast', 'SEVP August 24 Broadcast', 'USCardForum discussion'],
  },
  'prevailing-wage': {
  ...
  'h4-ead': {
    ...
    milestones: [
      ...
      { date: 'As of 2026-09-16', text: 'No NPRM, comment period, or effective date has been announced.' },
    ],
    next: [
